...
spl_autoload_register(function ($sitt){
    $sitt = substr($sitt,4);
    $sitt = str_replace('\\', '/', $sitt);
    require_once __DIR__ . '/../src/' . $sitt . '.php';
});

use App\Controllers\PublicController as SHORTCUT; // "as" on alias 

// require_once __DIR__ . '/../src/Router.php';
// require_once __DIR__ . '/../src/DB.php';

$controller = new SHORTCUT();
